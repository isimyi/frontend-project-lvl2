...
const expectedResultPlain = fs.readFileSync(getFixturePath('expected_result_json.json'), { encoding: 'utf8' });
...
test('genDiff', () => {
  ...
  expect(genDiff(getFixturePath('file1.json'), getFixturePath('file2.json'), 'json')).toEqual(expectedResultPlain);
  expect(genDiff(getFixturePath('file1.yml'), getFixturePath('file2.yml'), 'json')).toEqual(expectedResultPlain);
});
